...
# Needs to be edited to support multiple pages of information. Right now it fails if too much info is passed to discord.

def createEmbed(mongoHelpers, fx_collection):
